...
<body>
    <div class="horaLogo">
        <div class="logoInd">
            <a href="index.php">
                <img class="logo" src="Logo Punto Deportivo Compacto.png" alt="Punto Deportivo - Dashboard Errores">
            </a>
        </div>
    ...
    <div class="dashFacOnline">
        <div class="card factura-elec-card">
        ...
        <div class="card card--hidden notas-credito-card">
...
async function fetchFacturaElectronica() {
    try {
        ...
        const facturaElecCard = document.querySelector('.factura-elec-card');
...
// Ajustá el intervalo (en milisegundos) si necesitás más o menos frecuencia.
